...
{
    [Route("/ProwlNotifications", "POST", Summary = "Saves a notification", IsHidden = true)]
    [Authenticated(Roles = "Admin")]
    public class SaveNotification : ProwlNotificationInfo, IReturnVoid
    {
    }

    [Route("/ProwlNotifications/Default", "GET", Summary = "Gets default notification info", IsHidden = true)]
    [Authenticated(Roles = "Admin")]
    public class GetDefaultNotificationInfo : IReturn<ProwlNotificationInfo>
    {
    }

    [Route("/ProwlNotifications/Send/Test", "POST", Summary = "Sends a notification request, for testing only", IsHidden = true)]
    [Authenticated(Roles = "Admin")]
    public class SendNotificationTest : ProwlNotificationInfo
    {
    }

    [Route("/ProwlNotifications", "DELETE", Summary = "Deletes a notification", IsHidden = true)]
    [Authenticated(Roles = "Admin")]
    ...
    public class NotificationsApi : IService, IRequiresRequest
    {
        ...
        {
            return new ProwlNotificationInfo();
        }
        ...
        public void Post(SaveNotification request)
        {
            ...
            var updatedNotification = _json.DeserializeFromString<ProwlNotificationInfo>(_json.SerializeToString(request));
        ...
        private InternalNotificationRequest GetSampleNotificationRequest(ProwlNotificationInfo request)
        {
